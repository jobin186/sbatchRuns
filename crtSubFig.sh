...
inputFig="/home/jobinkv/temp1/Img" # a folder contain figures which canbe acced by any node
fold="Img"
outPut="/home/jobinkv/subFigs_CVPR67"
mkdir -p $outPut
...
matlab -nodesktop -nosplash -r "creatingSubfig('"$SSD$fold"/','"$SSD"out/')"
rsync -avz $SSD/out jobinkv@10.2.16.195:~/
